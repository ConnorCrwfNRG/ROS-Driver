#include "roboteq_motor_controller_driver/diff_odom_node.h"
...
void RoboteqOdom::encoderCallback(const roboteq_motor_controller_driver::channel_values& tick){
	...
	ROS_INFO("%f is encoder_left_", encoder_left_);
